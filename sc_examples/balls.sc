import rand define max_nb_balls 200 define rmax 6 define rmin 3 define width 128 define height 96 define panel_width 128 define panel_height 96 external CRGB leds[panel_height, panel_width];
external void show();
external void clear();
